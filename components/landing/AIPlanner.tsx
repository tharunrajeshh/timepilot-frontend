        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_1fr] lg:items-end">
          ...
          <div className="lg:pb-1 lg:pl-12">
            <p className="max-w-xl text-base leading-7 text-black/60 sm:text-lg">
              Your tasks don't need another complicated system. Tell
              TimePilot what matters and AI turns your workload into a
              practical schedule.
            </p>
          </div>
        </div>
          ...
          <div className="flex items-center justify-between border-b border-black/[0.1] px-5 py-5 sm:px-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[9px] font-medium text-black/50">
            ...
            <div className="border-b border-black/[0.1] p-7 sm:p-9 lg:border-b-0 lg:border-r lg:p-10">
              ...
              <div className="mt-5 rounded-2xl border border-black/[0.1] bg-white p-5 shadow-[0_10px_35px_rgba(0,0,0,0.05)]">
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="text-[11px] leading-6 text-black/70 font-medium">
                      Plan my day around my most important tasks. I have a
                      team meeting at 11:30 and want at least 4 hours of deep
                      work.
                    </p>
                  </div>
              ...
              {planned && (
                <div className="mt-4 flex items-center gap-3 rounded-xl border border-emerald-500/20 bg-emerald-500/[0.08] p-4">
                  ...
                  <p className="text-[10px] leading-5 text-black/60 font-medium">
              ...
              <div className="mt-8 flex items-center gap-3 border-t border-black/[0.1] pt-6">
                ...
                <p className="text-[10px] leading-5 text-black/50 font-medium">
              ...
              <div className="relative mt-6 overflow-hidden rounded-2xl border border-blue-500/[0.2] bg-gradient-to-r from-blue-500/[0.09] to-transparent p-5">
                ...
                <div className="relative flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-[10px] leading-5 text-black/55 font-medium">
                      I've protected your morning focus window and placed
                      a recovery period before your afternoon deep-work
                      session.
                    </p>
                  </div>
                </div>
  ...
  return (
    <div
      className={`
        ...
        hover:-translate-y-0.5 hover:shadow-[0_12px_35px_rgba(0,0,0,0.08)]

        ${
          isFocus
            ? "border-blue-500/[0.15] bg-blue-500/[0.04]"
    ...
    >
      {/* Time */}
      <div className="w-12 shrink-0 text-[10px] font-bold text-black/55">
        {task.time}
      </div>
      ...
      <div
        className={`
          ...
          ${
            isFocus
              ? "bg-blue-500/[0.12] text-blue-600"
              : isBreak
                ? "bg-black/[0.06] text-black/40"
                : "bg-purple-500/[0.1] text-purple-600"
          }
        `}
      >
        {isFocus ? (
...
function Control({
  ...
  return (
    <div className="rounded-xl border border-black/[0.08] bg-white p-3.5 shadow-[0_5px_20px_rgba(0,0,0,0.03)] transition-all hover:border-black/[0.12]">
      <p className="text-[9px] font-semibold text-black/40">
        {label}
      </p>

      <p className="mt-1.5 text-[11px] font-bold text-black/70">
        {value}
      </p>
    </div>
  );
...
function MiniMetric({
  ...
  return (
    <div className="rounded-xl border border-black/[0.08] bg-white p-3.5">
      <p
        className={`text-base font-bold ${colors[accent]}`}
      >
        {value}
      </p>

      <p className="mt-1.5 text-[8px] uppercase font-bold tracking-[0.12em] text-black/40">
        {label}
      </p>
    </div>
  );
    ...
    <div className="group rounded-2xl border border-black/[0.08] bg-white p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_15px_40px_rgba(0,0,0,0.08)]">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2.5">
          <span
            className={`h-2 w-2 rounded-full ${backgrounds[accent]}`}
          />

          <span
            className={`text-[10px] font-bold ${colors[accent]}`}
          >
            {number}
          </span>
        </div>
      ...
      <p className="mt-2 text-[10px] leading-5 text-black/50 font-medium">
        {text}
      </p>
    </div>
  );
